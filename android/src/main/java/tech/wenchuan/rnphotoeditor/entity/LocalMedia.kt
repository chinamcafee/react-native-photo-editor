package tech.wenchuan.rnphotoeditor.entity
...
class LocalMedia() : Parcelable {
    ...
    var isOriginalPicture: Boolean = false
    ...
    constructor(parcel: Parcel) : this() {
        ...
        isOriginalPicture = parcel.readByte() != 0.toByte()
    }
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + isOriginalPicture.hashCode()
        return result
    }
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeByte(if (isOriginalPicture) 1 else 0)
    }
