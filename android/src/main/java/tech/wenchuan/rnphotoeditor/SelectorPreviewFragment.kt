...
import tech.wenchuan.rnphotoeditor.adapter.PreviewAudioHolder
import tech.wenchuan.rnphotoeditor.adapter.PreviewVideoHolder
...
import tech.wenchuan.rnphotoeditor.magical.MagicalView
import tech.wenchuan.rnphotoeditor.magical.OnMagicalViewListener
...
open class SelectorPreviewFragment : BaseSelectorFragment() {
    ...
    open fun onOriginalClick(v: View) {
        println("SelectorPreviewFragment.kt onOriginalClick invoked ====="+ !v.isSelected)
