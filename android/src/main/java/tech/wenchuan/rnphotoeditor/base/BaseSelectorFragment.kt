package tech.wenchuan.rnphotoeditor.base
...
import tech.wenchuan.rnphotoeditor.SelectorCameraFragment
import tech.wenchuan.rnphotoeditor.SelectorExternalPreviewFragment
import tech.wenchuan.rnphotoeditor.SelectorMainFragment
import tech.wenchuan.rnphotoeditor.SelectorPreviewFragment
import tech.wenchuan.rnphotoeditor.SelectorSupporterActivity
import tech.wenchuan.rnphotoeditor.SelectorSystemFragment
import tech.wenchuan.rnphotoeditor.SelectorTransparentActivity
import tech.wenchuan.rnphotoeditor.app.SelectorAppMaster
import tech.wenchuan.rnphotoeditor.config.MediaType
import tech.wenchuan.rnphotoeditor.config.SelectionMode
import tech.wenchuan.rnphotoeditor.constant.CropWrap
import tech.wenchuan.rnphotoeditor.constant.SelectedState
import tech.wenchuan.rnphotoeditor.constant.SelectorConstant
import tech.wenchuan.rnphotoeditor.dialog.PhotoItemSelectedDialog
import tech.wenchuan.rnphotoeditor.dialog.PictureLoadingDialog
import tech.wenchuan.rnphotoeditor.dialog.ReminderDialog
...
import tech.wenchuan.rnphotoeditor.immersive.ImmersiveManager.translucentStatusBar
import tech.wenchuan.rnphotoeditor.interfaces.OnCallbackListener
import tech.wenchuan.rnphotoeditor.interfaces.OnItemClickListener
import tech.wenchuan.rnphotoeditor.interfaces.OnRecordAudioListener
import tech.wenchuan.rnphotoeditor.language.Language
import tech.wenchuan.rnphotoeditor.language.PictureLanguageUtils
import tech.wenchuan.rnphotoeditor.media.ScanListener
...
import tech.wenchuan.rnphotoeditor.permissions.PermissionUtil
...
import tech.wenchuan.rnphotoeditor.registry.ImageCaptureComponent
import tech.wenchuan.rnphotoeditor.registry.SoundCaptureComponent
import tech.wenchuan.rnphotoeditor.registry.VideoCaptureComponent
import tech.wenchuan.rnphotoeditor.service.ForegroundService
import tech.wenchuan.rnphotoeditor.utils.FileUtils
import tech.wenchuan.rnphotoeditor.utils.MediaStoreUtils
import tech.wenchuan.rnphotoeditor.utils.MediaUtils
import tech.wenchuan.rnphotoeditor.utils.SpUtils
import tech.wenchuan.rnphotoeditor.viewmodel.GlobalViewModel
import tech.wenchuan.rnphotoeditor.viewmodel.SelectorViewModel
import java.io.File
...
//                media.isOriginalPicture = globalViewMode.getOriginalLiveData().value ?: false
//            }
    ...
    open fun confirmSelect(media: LocalMedia, isSelected: Boolean): Int {
        val isOriginChecked = globalViewMode.getOriginalLiveData().value?.not() == false
        ...
        return if (isSelected) {
            ...
            if (config.selectionMode == SelectionMode.SINGLE) {
                if (getSelectResult().isNotEmpty()) {
                    val result = getSelectResult().first()
                    result.isOriginalPicture = isOriginChecked
                    globalViewMode.setSelectResultLiveData(result)
                    getSelectResult().clear()
                }
            }
            if (!getSelectResult().contains(media)) {
                if (isOriginChecked) {
                   media.isOriginalPicture = true
                }
