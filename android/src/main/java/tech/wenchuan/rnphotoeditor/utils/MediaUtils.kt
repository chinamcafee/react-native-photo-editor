...
import tech.wenchuan.rnphotoeditor.entity.MediaInfo
import tech.wenchuan.rnphotoeditor.loader.BUCKET_DISPLAY_NAME
import tech.wenchuan.rnphotoeditor.loader.BUCKET_ID
import tech.wenchuan.rnphotoeditor.loader.DURATION
import tech.wenchuan.rnphotoeditor.loader.ORIENTATION
import tech.wenchuan.rnphotoeditor.utils.SdkVersionUtils.isO
import tech.wenchuan.rnphotoeditor.utils.SdkVersionUtils.isR
...
object MediaUtils {
    ...
    fun parUri(context: Context, cameraFile: File): Uri {
        val authority = context.packageName + ".linkUProvider"
